...
const output = {
  ...
  source: 'Raumwaerme- und Warmwasserbedarf privater Haushalte Deutschland nach UBA und AGEB Anwendungsbilanz 2023 (445 TWh Raumwaerme + 85 TWh Warmwasser); bereits elektrisch gedeckt rund 50 TWh Waerme (Bestand-WP ~22 TWh, Nachtspeicher/Direktheizung ~13 TWh, Durchlauferhitzer/Boiler ~15 TWh); JAZ 3,3 als bewusste Mitte der empirischen Spannbreite Luft-Wasser 2,8-3,4 (pessimistisch: WPZ Buchs/OST 2,9 herstellerunabhaengig, Lokale Agenda 21 Lahr 2,8; mittig: UBA Climate Change 11/2024 3,1, Agora Energiewende 2023 3,2; optimistisch: Fraunhofer ISE WP-QS im Bestand 2025 3,4 mit Herstellerbeteiligung); Gradtagszahl-Profil aus realen Tagesmitteltemperaturen 2025 (Open-Meteo ERA5, 8-Staedte-Mittel, kalibriert aufs DWD-Gebietsmittel DE pro Monat).',
  sourceUrls: [
