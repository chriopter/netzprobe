...
- **Szenarien-Anpassungen:**
  - Neuer H2-Import-Schieberegler im Last-Bereich: importierter Wasserstoff reduziert proportional den inländischen Strombedarf der H2-konsumierenden Sektoren. Allokation nach Priorität — Flug (η 0,38) zuerst, dann Schiff (0,50), Chemie (0,55), Stahl (0,64); Quellen BMWK H2-Importstrategie und Ariadne.
...
- `data/` nach Domänen gruppiert (`erzeugung/`, `last/`, `speicher/`, `presets/`, `kern/`); IDs ohne Prefix.
