...
// aggregiert 15-min auf 1h, schreibt model/erzeugung/2017/data.json und model/last/2017/hours.json.
// Run: node model/erzeugung/2017/generate.mjs
...
writeFileSync('model/erzeugung/2017/data.json', JSON.stringify(erz));
writeFileSync('model/last/2017/hours.json', JSON.stringify(lastHours));
