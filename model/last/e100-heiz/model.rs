...
#[derive(Debug, Clone)]
pub struct E100HeizData {
    pub already_electric_heat_twh: f64,
    pub seasonal_cop: f64,
    pub hourly_multipliers: [f64; 24],
}

pub fn additional_heat_twh(target_heat_twh: f64, model: &E100HeizData) -> f64 {
    (target_heat_twh - model.already_electric_heat_twh).max(0.0)
}

pub fn additional_electricity_twh(target_heat_twh: f64, model: &E100HeizData) -> f64 {
