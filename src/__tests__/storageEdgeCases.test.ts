...
const noopSchiff: E100SchiffData = { id: 'e100-schiff', title: 'X', source: 'T', sourceUrls: [], referenceYear: 2023, directElectrificationTWh: 0, eFuelSynthesisTWh: 0, alreadyElectricTWh: 0, defaultTargetTWh: 0, maxTargetTWh: 0, stepTWh: 1, distribution: 'hourly-profile', hourlyProfile: { source: 'T', multipliers: flatMul }, note: 'T', summary: 'T' };
...
const noopChemie: E100ChemieData = { id: 'e100-chemie', title: 'X', source: 'T', sourceUrls: [], referenceYear: 2023, currentElectricityTWh: 0, processHeatSubstitutionTWh: 0, hydrogenAmmoniaTWh: 0, hydrogenMethanolTWh: 0, eOlefinsViaH2TWh: 0, additionalDirectElectricityTWh: 0, defaultTargetTotalTWh: 0, maxTargetTotalTWh: 0, stepTWh: 1, alreadyElectricTWh: 0, distribution: 'hourly-profile', hourlyProfile: { source: 'T', multipliers: flatMul }, note: 'T', summary: 'T' };
