...
export const defaultScenario: Scenario = {
  id: 'e100-dashboard',
  name: '100 % Elektrifizierung',
  description: 'Historische Energy-Charts-Daten 2025 mit additiven Elektrifizierungsbausteinen.',
  demand: {
    'last-2025': true,
    'e100-pkw': true, 'e100-pkw-million-km': 369_000,
    'e100-heiz': true, 'e100-heiz-target-heat-twh': 530,
    'e100-lkw': true, 'e100-lkw-target-bn-km': 93,
    'e100-bahn': true, 'e100-bahn-target-twh': 10,
    'e100-schiff': true, 'e100-schiff-target-twh': 80,
    'e100-flug': true, 'e100-flug-target-twh': 300,
    'e100-ghd': true, 'e100-ghd-target-heat-twh': 138,
...
export function normalizeScenario(scenario: Scenario): Scenario {
  ...
  return {
    ...
    demand: {
      ...
      'e100-pkw-million-km': demand['e100-pkw-million-km'] ?? 369_000,
