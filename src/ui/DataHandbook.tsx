  ...
  return <main className="min-h-screen bg-white px-3 py-3 text-zinc-950 sm:px-4 lg:px-6">
    <div className="mx-auto grid w-full max-w-5xl gap-6 lg:grid-cols-[250px_minmax(0,1fr)]">
      ...
      <article className="min-w-0 pb-12">
        {!docs.length ? <p className="p-5 text-zinc-500">Lade Datenhandbuch …</p> : selectedId && !selected ? <p className="p-5 text-zinc-500">Datensatz nicht gefunden.</p> : !selected ? <DataHandbookHome docs={docs}/> : <DatasetArticle selected={selected}/>}
      </article>
    </div>
  </main>;
}
