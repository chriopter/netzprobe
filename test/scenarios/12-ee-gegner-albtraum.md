...
## Kurzbeschreibung
„Wenn ihr EE wegmacht und nichts dazubaut": Kohle bleibt heutigem Bestand, PV/Wind auf 2025-Stand, kein H2-Import, importMaxGW auf 0 → komplette Inland-Versorgung mit dem heutigen Mix. Sollte zeigen dass aktuelles System ohne EE-Ausbau zusammenbricht.
...
```json
{
  ...
  "generation": {
    ...
    "importMaxGW": 0, "exportMaxGW": 25, "importEmissionGperKWh": 300
  },
  "storage": {
